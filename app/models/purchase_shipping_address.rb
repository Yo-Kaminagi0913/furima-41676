class PurchaseShippingAddress
  ...
  with_options presence: true do
    ...
    validates :phone_number, length: { minimum: 10, maximum: 11, message: 'is too short' }, format: { only_integer: true, with: /\A\d{10,11}\z/, message: 'is invalid. Input only number' }
  end
