class Item < ApplicationRecord
  ...
  validates :price, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999 }, if: -> { price.present? }
  validates :price, format: { with: /\A[0-9]+\z/ }, if: -> { price.present? }
